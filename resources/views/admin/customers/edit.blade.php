...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="/customers">Users</a></li>
        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-6 col-md-12">
                <div class="card">
                    ...
                    <form action="{{route('customer.update', '$customer->id)}}" method="POST" name="edit_customer" id="edit_customer" class="">                    
                        <div class="card-body">
