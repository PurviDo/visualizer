...
<section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-end align-items-center">
                        <button type="button" class="btn btn-info add-item-button" data-toggle="modal" data-target="#changePasswordModal">Change Password</button>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade text-left drawer-right change-password-modal" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
...
<script>
    $(function() {
        ...
        function createAlertHtml(message, type = 'dark') {
            return `
